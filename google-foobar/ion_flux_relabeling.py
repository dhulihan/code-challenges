...
def generate_tree(height):
    rootVal = math.pow(2, height) - 1
    remainingLevels = height - 1


    r = BinaryTree(rootVal)
    print(r.key, "nodes to fill")
    indent = "\t"
    for i in reversed(range(0, remainingLevels)):
